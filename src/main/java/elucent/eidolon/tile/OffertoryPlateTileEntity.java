...
public class OffertoryPlateTileEntity extends TileEntityBase {
    ItemStack stack = ItemStack.EMPTY;

    public OffertoryPlateTileEntity() {
        this(Registry.OFFERTORY_PLATE_TILE_ENTITY);
    }

    public OffertoryPlateTileEntity(TileEntityType<?> tileEntityTypeIn) {
