...
public class PodiumTileEntity extends TileEntityBase {
    ItemStack stack = ItemStack.EMPTY;

    public PodiumTileEntity() {
        this(Registry.PODIUM_TILE_ENTITY);
    }

    public PodiumTileEntity(TileEntityType<?> tileEntityTypeIn) {
        ...
        if (hand == Hand.MAIN_HAND) {
            if (player.getHeldItem(hand).isEmpty() && !stack.isEmpty()) {
                ...
                return ActionResultType.SUCCESS;
                    ...
                    && player.getHeldItem(hand).getItem() == Registry.CODEX.get()
                    && stack.isEmpty()) {
