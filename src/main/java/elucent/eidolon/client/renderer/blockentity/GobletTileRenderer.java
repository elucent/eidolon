...
public class GobletTileRenderer extends ModBlockEntityRenderer<GobletTileEntity> {

    public GobletTileRenderer(BlockEntityRenderDispatcher rendererDispatcherIn) {
