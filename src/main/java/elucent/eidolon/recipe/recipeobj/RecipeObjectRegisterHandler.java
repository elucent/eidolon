...
public class RecipeObjectRegisterHandler {
    ...
    public static final RecipeObjectType<TagKey<Item>, RecipeItemTag> TAG = RecipeObjectType.create(RecipeItemTag::new);
    ...
    static {
        ...
        TYPES.put(TagKey.class, TAG.setRegistryName("tag"));
