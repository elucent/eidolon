...
public class CatacombPieces {
    ...
    public static class CorridorCenter extends RandomlyRotatedPiece {
        public CorridorCenter(TemplateManager templateManager, CompoundTag nbt) { super(CORRIDOR_CENTER, CORRIDOR_CENTER_ID, templateManager, nbt); }
    ...
    public static class CorridorDoor extends BasicPiece {
        public CorridorDoor(TemplateManager templateManager, CompoundTag nbt) { super(CORRIDOR_DOOR, CORRIDOR_DOOR_ID, templateManager, nbt); }
    ...
    public static class SmallRoom extends RandomlyRotatedPiece {
        public SmallRoom(TemplateManager templateManager, CompoundTag nbt) { super(SMALL_ROOM, SMALL_ROOM_ID, templateManager, nbt); }
    ...
    public static class Trap extends RandomlyRotatedPiece {
        public Trap(TemplateManager templateManager, CompoundTag nbt) { super(TRAP, TRAP_ID, templateManager, nbt); }
    ...
    public static class Shrine extends RandomlyRotatedPiece {
        public Shrine(TemplateManager templateManager, CompoundTag nbt) { super(SHRINE, SHRINE_ID, templateManager, nbt); }
    ...
    public static class Skull extends RandomlyRotatedPiece {
        public Skull(TemplateManager templateManager, CompoundTag nbt) { super(SKULL, SKULL_ID, templateManager, nbt); }
    ...
    public static class Spawner extends RandomlyRotatedPiece {
        public Spawner(TemplateManager templateManager, CompoundTag nbt) { super(SPAWNER, SPAWNER_ID, templateManager, nbt); }
    ...
    public static class Coffin extends RandomlyRotatedPiece {
        public Coffin(TemplateManager templateManager, CompoundTag nbt) { super(COFFIN, COFFIN_ID, templateManager, nbt); }
    ...
    public static class MediumRoom extends RandomlyRotatedPiece {
        public MediumRoom(TemplateManager templateManager, CompoundTag nbt) { super(MEDIUM_ROOM, MEDIUM_ROOM_ID, templateManager, nbt); }
    ...
    public static class Graveyard extends RandomlyRotatedPiece {
        public Graveyard(TemplateManager templateManager, CompoundTag nbt) { super(GRAVEYARD, GRAVEYARD_ID, templateManager, nbt); }
    ...
    public static class Turnaround extends RandomlyRotatedPiece {
        public Turnaround(TemplateManager templateManager, CompoundTag nbt) { super(TURNAROUND, TURNAROUND_ID, templateManager, nbt); }
    ...
    public static class Lab extends RandomlyRotatedPiece {
        public Lab(TemplateManager templateManager, CompoundTag nbt) { super(LAB, LAB_ID, templateManager, nbt); }
