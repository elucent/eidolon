...
public class EnchantedAshBlock extends BlockBase {
    ...
    public void updateIndirectNeighbourShapes(BlockState state, Level worldIn, BlockPos pos, int flags, int recursionLeft) {
    ...
    public VoxelShape getCollisionShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext ctx) {
        return isBlocked(((EntityCollisionContext) ctx).getEntity()) ? BARRIER_SHAPE : super.getCollisionShape(state, world, pos, ctx);
    }
