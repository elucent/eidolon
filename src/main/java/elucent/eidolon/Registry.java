...
public class Registry {
    ...
    static <T extends TileEntityBase> TileEntityType<T> addTileEntity(IForgeRegistry<TileEntityType<?>> registry, String name, Supplier<T> factory, Block block) {
        ...
        if (block instanceof BlockBase) ((BlockBase)block).setTile(type);
        return type;
    }
    ...
    public static RegistryObject<Block>
        ...
        CRAFTING_ALTAR = addBlock("crafting_altar", new HorizontalBlockBase(blockProps(Material.WOOD, MaterialColor.WOOD)
            .hardnessAndResistance(2.5f, 3.0f)
            .harvestLevel(0).harvestTool(ToolType.AXE).notSolid())
            .setShape(VoxelShapes.combine(
                VoxelShapes.create(0, 0, 0, 1, 0.875, 1),
                VoxelShapes.create(0.25, 0.875, 0.25, 0.75, 1, 0.75),
                IBooleanFunction.OR))),
    ...
    public static RegistryObject<EntityType<WraithEntity>>
        WRAITH = addEntity("wraith", 0x706e6b, 0xadacbd, 0.6f, 2.0f, WraithEntity::new, EntityClassification.MONSTER);
    ...
    public static TileEntityType<CraftingAltarTileEntity> CRAFTING_ALTAR_TILE_ENTITY;
    ...
    public void registerTiles(RegistryEvent.Register<TileEntityType<?>> evt) {
        ...
        CRAFTING_ALTAR_TILE_ENTITY = addTileEntity(evt.getRegistry(), "crafting_altar", CraftingAltarTileEntity::new, CRAFTING_ALTAR.get());
