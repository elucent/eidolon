...
public class NecromancerEntity extends SpellcastingIllagerEntity {
    public NecromancerEntity(EntityType<? extends SpellcastingIllagerEntity> type, Level worldIn) {
        super(type, worldIn);
    }
    ...
    public void tick() {
        ...
        if (this.level.isClientSide && this.isCastingSpell()) {
            SpellType spelltype = getCurrentSpell();
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(10, new LookAtPlayerGoal(this, MobEntity.class, 8.0F));
        this.goalSelector.addGoal(7, new WaterAvoidingRandomWalkingGoal(this, 1.0D));
        this.targetSelector.addGoal(2, (new NearestAttackableTargetGoal<>(this, Player.class, 10, false, false, (e) -> e.getCommandSenderWorld().getCapability(ReputationProvider.CAPABILITY).isPresent() && e.getCommandSenderWorld().getCapability(ReputationProvider.CAPABILITY).resolve().get().getReputation((Player)e, Deities.DARK_DEITY.getId()) >= 50)).setUnseenMemoryTicks(300));
    }
